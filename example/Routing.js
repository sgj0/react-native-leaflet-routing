...
import WebViewLeafletRouting from 'react-native-leaflet-routing';
...
export default class Routing extends React.Component {
  ...
  */
  ...
  // display the map within the webview
  renderWebView = () => {
    return !this.state.mapCenterPosition.length || !this.state.ownPositionMarker
      ? null
      : (<WebViewLeafletRouting ref={(component) => (this.webViewLeaflet = component)} eventReceiver={this} centerPosition={this.state.mapCenterPosition} ownPositionMarker={this.state.ownPositionMarker} routingMarkers={this.state.routingMarkers}/>);
  }
